...
func TestCompileEffect(t *testing.T) {
	tests := []struct {
		...
		{"parcial vira manual", "Discard 2 cards from your hand. Then, draw 4 cards.",
		...
		{"busca com condição de HP vira manual", "Search your deck for up to 2 Basic Pokémon with 70 HP or less and put them onto your Bench. Then, shuffle your deck.",
			CompiledEffect{Manual: true}},
